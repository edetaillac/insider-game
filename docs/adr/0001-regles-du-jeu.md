...
D7 (24/09/2026, gameplay, prolongement de D6). Même écran d'enquête pour tous. Les téléphones restent posés cinq minutes : un bloc sombre visible chez le Traître seul le trahit à distance. Décision : pendant l'enquête, Citoyens et Traître ont exactement le même rendu au repos, un bloc « Le mot, maintiens pour voir ». L'appui maintenu révèle le mot au Traître et « Tu ne connais pas le mot » au Citoyen, sans son ni vibration. Le Maître garde le mot affiché en permanence, son rôle est public. Même principe à l'attente du choix du mot : le rôle du joueur n'y apparaît plus en clair, il se revoit par appui maintenu. Question ouverte : si le geste n'est pas compris à table, passer à un tap qui affiche 3 s, identique pour tous
